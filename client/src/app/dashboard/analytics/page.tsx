export default function Page() {
  return (
    <div className="flex h-[70vh] flex-col items-center justify-center rounded-xl border border-dashed border-border text-center">
      ...
      <h1 className="mt-2 font-display text-xl font-semibold">Analytics</h1>
      <p className="mt-2 max-w-md text-sm text-text-muted">Deep-dive charts on leads, conversion, email performance, sales and team.</p>
