export default function Page() {
  return (
    <div className="flex h-[70vh] flex-col items-center justify-center rounded-xl border border-dashed border-border text-center">
      ...
      <h1 className="mt-2 font-display text-xl font-semibold">Calendar</h1>
      <p className="mt-2 max-w-md text-sm text-text-muted">Meetings, follow-ups, project deadlines and payment due dates.</p>
