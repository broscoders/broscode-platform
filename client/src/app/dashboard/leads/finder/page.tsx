export default function Page() {
  return (
    <div className="flex h-[70vh] flex-col items-center justify-center rounded-xl border border-dashed border-border text-center">
      ...
      <h1 className="mt-2 font-display text-xl font-semibold">AI Lead Finder</h1>
      <p className="mt-2 max-w-md text-sm text-text-muted">Search for real, verified businesses by industry, category, city and country — wired to Google Places API.</p>
